/*
 * sim-fast.c - *fast* functional simulator implementation
 *
...
{
  opt_reg_header(odb, 
"sim-safe: This simulator implements a *fast* functional simulator.\n"
		 );
...
#define READ_BYTE(SRC, FAULT)						\
  MEM_READ_BYTE(mem, addr = (SRC))
#define READ_HALF(SRC, FAULT)						\
  MEM_READ_HALF(mem, addr = (SRC))
#define READ_WORD(SRC, FAULT)						\
  MEM_READ_WORD(mem, addr = (SRC))
#ifdef HOST_HAS_QWORD
#define READ_QWORD(SRC, FAULT)						\
  MEM_READ_QWORD(mem, addr = (SRC))
#endif /* HOST_HAS_QWORD */

#define WRITE_BYTE(SRC, DST, FAULT)					\
  MEM_WRITE_BYTE(mem, addr = (DST), (SRC))
#define WRITE_HALF(SRC, DST, FAULT)					\
  MEM_WRITE_HALF(mem, addr = (DST), (SRC))
#define WRITE_WORD(SRC, DST, FAULT)					\
  MEM_WRITE_WORD(mem, addr = (DST), (SRC))
#ifdef HOST_HAS_QWORD
#define WRITE_QWORD(SRC, DST, FAULT)					\
  MEM_WRITE_QWORD(mem, addr = (DST), (SRC))
#endif /* HOST_HAS_QWORD */
