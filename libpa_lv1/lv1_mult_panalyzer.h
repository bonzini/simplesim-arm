/*
* mult_panalyzer.h - branch prediction power analysis 
* 
*
...
#ifndef MULT_PANALYZER_H 
#define MULT_PANALYZER_H
...
/* mult power specification type:
 * contain all the info for analyzing mult pdissipation */
typedef struct _fu_lv1_mult_pspec_t {
	char *name; /* name */
	double freq, volt; /* operating frequency/supply voltage */
	double iCeff;
	unsigned long mult_access;
	double mult_total_power;
	double mult_power;
	double max_power;
} fu_lv1_mult_pspec_t;
 ...
 * caution: please deallocate the mult space  */
fu_lv1_mult_pspec_t *
...
void 
lv1_mult_panalyzer(
	fu_lv1_mult_pspec_t *pspec 
	);
#endif /* MULT_PANALYZER_H */
