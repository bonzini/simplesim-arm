/*
* lv1_alu_panalyzer.c - branch prediction power model 
* 
*
...
create_alu_panalyzer(
	...
	double iCeff)
{
	fu_lv1_alu_pspec_t *pspec;

	fprintf(stderr, "\n****************************************************\n");
	fprintf(stderr, "\t\t level 1 power model alu panalyzer configuration\n");
	fprintf(stderr,   "****************************************************\n");
	if(!(pspec = (fu_lv1_alu_pspec_t *)malloc(sizeof(fu_lv1_alu_pspec_t))))
...
/* level 1 power model alu panalyzer */
void 
lv1_alu_panalyzer(
	fu_lv1_alu_pspec_t *pspec
	)
