/*
* lv1_bpred_panalyzer.c - branch prediction power model 
* 
*
...
/* create level 1 power model bpred panalyzer database
 * return an allocated location pointer.
 * caution: please deallocate the lv1_bpred space  */
fu_lv1_bpred_pspec_t *
create_bpred_panalyzer(
	char *name, /* lv1_bpred name */
	int freq,double volt,
	double iCeff)
{
	fu_lv1_bpred_pspec_t *pspec;

	fprintf(stderr, "\n****************************************************\n");
	fprintf(stderr, "\t\t level 1 power model bpred panalyzer configuration\n");
	fprintf(stderr,   "****************************************************\n");
	if(!(pspec = (fu_lv1_bpred_pspec_t *)malloc(sizeof(fu_lv1_bpred_pspec_t))))
	...
	pspec->volt = volt;
	pspec->freq = freq;
	pspec->bpred_access = 0;
	pspec->bpred_total_power = 0;
	pspec->bpred_power = 0;
	pspec->max_power = 0;
...
/* level 1 power model bpred panalyzer */
void 
lv1_bpred_panalyzer(
	fu_lv1_bpred_pspec_t *pspec 
	)
{
	...
	pspec->bpred_access++;
	pspec->bpred_total_power += dynamic_power; 
	pspec->bpred_power += dynamic_power; 
	pspec->max_power = 
