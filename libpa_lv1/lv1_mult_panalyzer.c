/*
* lv1_mult_panalyzer.c - branch prediction power model 
* 
*
	...
	double iCeff)
{
	...
	fprintf(stderr, "\n****************************************************\n");
	fprintf(stderr, "\t\t level 1 power model mult panalyzer configuration\n");
	fprintf(stderr,   "****************************************************\n");
	if(!(pspec = (fu_lv1_mult_pspec_t *)malloc(sizeof(fu_lv1_mult_pspec_t))))
