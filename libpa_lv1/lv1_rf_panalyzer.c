/*
* lv1_rf_panalyzer.c - branch prediction power model 
* 
*
 ...
 * caution: please deallocate the lv1_rf space  */
fu_lv1_rf_pspec_t *
create_rf_panalyzer(
	char *name, /* lv1_rf name */
	...
	double iCeff)
{
	...
	fprintf(stderr, "\n****************************************************\n");
	fprintf(stderr, "\t\t level 1 power model rf panalyzer configuration\n");
	fprintf(stderr,   "****************************************************\n");
	if(!(pspec = (fu_lv1_rf_pspec_t *)malloc(sizeof(fu_lv1_rf_pspec_t))))
	...
	)
{
	...
	pspec->rf_access++;
	pspec->rf_total_power += dynamic_power; 
	pspec->rf_power += dynamic_power; 
	pspec->max_power = 
